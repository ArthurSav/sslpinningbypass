...
.method public static a(Landroid/view/MenuItem;Landroid/support/v4/view/ActionProvider;)Landroid/view/MenuItem;
    ...
    instance-of v0, p0, Landroid/support/v4/internal/view/b;

    if-eqz v0, :cond_0

    check-cast p0, Landroid/support/v4/internal/view/b;

    invoke-interface {p0, p1}, Landroid/support/v4/internal/view/b;->a(Landroid/support/v4/view/ActionProvider;)Landroid/support/v4/internal/view/b;
...
.method public static a(Landroid/view/MenuItem;Landroid/view/View;)Landroid/view/MenuItem;
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/internal/view/b;->setActionView(Landroid/view/View;)Landroid/view/MenuItem;
...
.method public static a(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    invoke-interface {p0}, Landroid/support/v4/internal/view/b;->getActionView()Landroid/view/View;
...
.method public static a(Landroid/view/MenuItem;I)V
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/internal/view/b;->setShowAsAction(I)V
...
.method public static b(Landroid/view/MenuItem;I)Landroid/view/MenuItem;
    ...
    invoke-interface {p0, p1}, Landroid/support/v4/internal/view/b;->setActionView(I)Landroid/view/MenuItem;
...
.method public static b(Landroid/view/MenuItem;)Z
    ...
    invoke-interface {p0}, Landroid/support/v4/internal/view/b;->expandActionView()Z
...
.method public static c(Landroid/view/MenuItem;)Z
    ...
    invoke-interface {p0}, Landroid/support/v4/internal/view/b;->isActionViewExpanded()Z
