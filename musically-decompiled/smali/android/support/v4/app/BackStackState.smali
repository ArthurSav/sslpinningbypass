...
.method public constructor <init>(Landroid/support/v4/app/t;Landroid/support/v4/app/m;)V
    .locals 8
    ...
    iget-object v0, p2, Landroid/support/v4/app/m;->c:Landroid/support/v4/app/n;
    ...
    iget-object v2, v1, Landroid/support/v4/app/n;->i:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-object v1, v1, Landroid/support/v4/app/n;->a:Landroid/support/v4/app/n;

    goto :goto_0

    :cond_1
    iget v1, p2, Landroid/support/v4/app/m;->e:I
    ...
    iget-boolean v0, p2, Landroid/support/v4/app/m;->l:Z
    ...
    iget v4, v5, Landroid/support/v4/app/n;->c:I
    ...
    iget-object v0, v5, Landroid/support/v4/app/n;->d:Landroid/support/v4/app/Fragment;
    ...
    iget v2, v5, Landroid/support/v4/app/n;->e:I
    ...
    iget v4, v5, Landroid/support/v4/app/n;->f:I
    ...
    iget v4, v5, Landroid/support/v4/app/n;->g:I
    ...
    iget v4, v5, Landroid/support/v4/app/n;->h:I

    aput v4, v0, v1

    iget-object v0, v5, Landroid/support/v4/app/n;->i:Ljava/util/ArrayList;
    ...
    :goto_4
    iget-object v1, v5, Landroid/support/v4/app/n;->a:Landroid/support/v4/app/n;
    ...
    iget v0, p2, Landroid/support/v4/app/m;->k:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iget-object v0, p2, Landroid/support/v4/app/m;->n:Ljava/lang/String;
    ...
    iget v0, p2, Landroid/support/v4/app/m;->q:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iget-object v0, p2, Landroid/support/v4/app/m;->r:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iget v0, p2, Landroid/support/v4/app/m;->s:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iget-object v0, p2, Landroid/support/v4/app/m;->t:Ljava/lang/CharSequence;
    ...
    iget-object v0, p2, Landroid/support/v4/app/m;->v:Ljava/util/ArrayList;
...
# virtual methods
.method public a(Landroid/support/v4/app/t;)Landroid/support/v4/app/m;
    .locals 11
    ...
    invoke-direct {v6, p1}, Landroid/support/v4/app/m;-><init>(Landroid/support/v4/app/t;)V
    ...
    invoke-direct {v7}, Landroid/support/v4/app/n;-><init>()V
    ...
    iput v0, v7, Landroid/support/v4/app/n;->c:I
    ...
    iput-object v0, v7, Landroid/support/v4/app/n;->d:Landroid/support/v4/app/Fragment;
    ...
    iput v0, v7, Landroid/support/v4/app/n;->e:I
    ...
    iput v0, v7, Landroid/support/v4/app/n;->f:I
    ...
    iput v0, v7, Landroid/support/v4/app/n;->g:I
    ...
    iput v0, v7, Landroid/support/v4/app/n;->h:I
    ...
    iput-object v0, v7, Landroid/support/v4/app/n;->i:Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-virtual {v6, v7}, Landroid/support/v4/app/m;->a(Landroid/support/v4/app/n;)V
