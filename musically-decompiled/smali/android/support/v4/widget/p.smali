...
.field private c:Landroid/support/v4/widget/ba;
...
.method public constructor <init>(Landroid/support/v4/widget/DrawerLayout;I)V
    ...
    invoke-direct {v0, p0}, Landroid/support/v4/widget/p$1;-><init>(Landroid/support/v4/widget/p;)V

    iput-object v0, p0, Landroid/support/v4/widget/p;->d:Ljava/lang/Runnable;
...
.method static synthetic a(Landroid/support/v4/widget/p;)V
    .locals 0
...
.method private b()V
    ...
    :cond_0
    iget-object v1, p0, Landroid/support/v4/widget/p;->a:Landroid/support/v4/widget/DrawerLayout;
...
.method private c()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/p;->c:Landroid/support/v4/widget/ba;

    invoke-virtual {v1}, Landroid/support/v4/widget/ba;->b()I
    ...
    :cond_2
    iget-object v0, p0, Landroid/support/v4/widget/p;->a:Landroid/support/v4/widget/DrawerLayout;
    ...
    iget-object v3, p0, Landroid/support/v4/widget/p;->c:Landroid/support/v4/widget/ba;

    invoke-virtual {v2}, Landroid/view/View;->getTop()I

    move-result v5

    invoke-virtual {v3, v2, v1, v5}, Landroid/support/v4/widget/ba;->a(Landroid/view/View;II)Z
...
.method public a()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/p;->d:Ljava/lang/Runnable;
...
.method public a(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/p;->c:Landroid/support/v4/widget/ba;

    invoke-virtual {v2}, Landroid/support/v4/widget/ba;->c()Landroid/view/View;
...
.method public a(Landroid/support/v4/widget/ba;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/p;->c:Landroid/support/v4/widget/ba;
...
.method public a(Landroid/view/View;FF)V
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/widget/ba;->a(II)Z
...
.method public b(II)V
    ...
    invoke-virtual {v1, v0, p2}, Landroid/support/v4/widget/ba;->a(Landroid/view/View;I)V
