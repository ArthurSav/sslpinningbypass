...
.field protected f:Landroid/support/v4/widget/f;
...
.method a(Landroid/content/Context;Landroid/database/Cursor;I)V
    ...
    invoke-direct {v1, p0}, Landroid/support/v4/widget/f;-><init>(Landroid/support/v4/widget/CursorAdapter;)V

    iput-object v1, p0, Landroid/support/v4/widget/CursorAdapter;->f:Landroid/support/v4/widget/f;

    new-instance v1, Landroid/support/v4/widget/g;

    invoke-direct {v1, p0, v3}, Landroid/support/v4/widget/g;-><init>(Landroid/support/v4/widget/CursorAdapter;Landroid/support/v4/widget/CursorAdapter$1;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->f:Landroid/support/v4/widget/f;
    ...
    :cond_5
    iput-object v3, p0, Landroid/support/v4/widget/CursorAdapter;->f:Landroid/support/v4/widget/f;
...
.method public b(Landroid/database/Cursor;)Landroid/database/Cursor;
    ...
    iget-object v1, p0, Landroid/support/v4/widget/CursorAdapter;->f:Landroid/support/v4/widget/f;
...
.method public getFilter()Landroid/widget/Filter;
    ...
    iget-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->h:Landroid/support/v4/widget/h;

    if-nez v0, :cond_0

    new-instance v0, Landroid/support/v4/widget/h;

    invoke-direct {v0, p0}, Landroid/support/v4/widget/h;-><init>(Landroid/support/v4/widget/i;)V

    iput-object v0, p0, Landroid/support/v4/widget/CursorAdapter;->h:Landroid/support/v4/widget/h;
