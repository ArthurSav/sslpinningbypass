...
# instance fields
.field private a:Landroid/support/v7/app/i;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatDialog;->a()Landroid/support/v7/app/i;

    move-result-object v0

    const/4 v1, 0x0

    invoke-virtual {v0, v1}, Landroid/support/v7/app/i;->a(Landroid/os/Bundle;)V
...
# virtual methods
.method public a()Landroid/support/v7/app/i;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDialog;->a:Landroid/support/v7/app/i;

    if-nez v0, :cond_0

    invoke-static {p0, p0}, Landroid/support/v7/app/i;->a(Landroid/app/Dialog;Landroid/support/v7/app/h;)Landroid/support/v7/app/i;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDialog;->a:Landroid/support/v7/app/i;
...
.method public a(I)Z
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/app/i;->b(I)Z
...
.method public setTitle(I)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/app/i;->a(Ljava/lang/CharSequence;)V
