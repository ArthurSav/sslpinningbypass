...
.field k:Landroid/support/v7/internal/view/menu/f;
...
# virtual methods
.method a(Landroid/support/v7/internal/view/menu/u;)Landroid/support/v7/internal/view/menu/v;
    .locals 3
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/f;
    ...
    invoke-direct {v0, v1, v2}, Landroid/support/v7/internal/view/menu/f;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/f;

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v0, p1}, Landroid/support/v7/internal/view/menu/f;->a(Landroid/support/v7/internal/view/menu/u;)V

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->j:Landroid/support/v7/internal/view/menu/MenuBuilder;

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/MenuBuilder;->a(Landroid/support/v7/internal/view/menu/t;)V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/view/menu/f;->a(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/v;
...
.method a(Landroid/support/v7/internal/view/menu/MenuBuilder;)V
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/internal/view/menu/MenuBuilder;->a(Landroid/support/v7/internal/view/menu/t;)V
...
.method public a()Z
    ...
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->k:Landroid/support/v7/internal/view/menu/f;
