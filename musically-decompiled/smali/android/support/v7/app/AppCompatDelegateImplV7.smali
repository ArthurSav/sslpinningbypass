...
.field private n:Landroid/support/v7/internal/widget/t;

.field private o:Landroid/support/v7/app/o;

.field private p:Landroid/support/v7/app/r;
...
.method constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/h;)V
    ...
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v7/app/j;-><init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/h;)V
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->n:Landroid/support/v7/internal/widget/t;
...
.method private a(Landroid/support/v7/internal/view/menu/MenuBuilder;Z)V
    ...
    invoke-static {v0}, Landroid/support/v4/view/cv;->b(Landroid/view/ViewConfiguration;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->n:Landroid/support/v7/internal/widget/t;

    invoke-interface {v1}, Landroid/support/v7/internal/widget/t;->e()Z
    ...
    invoke-interface {v1}, Landroid/support/v7/internal/widget/t;->h()Z
...
.method private a(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;)Z
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/app/q;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/content/Context;)V
...
.method static synthetic b(Landroid/support/v7/app/AppCompatDelegateImplV7;I)I
    ...
    iput p1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->B:I
...
.method private b(Landroid/support/v7/internal/view/menu/MenuBuilder;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/t;->j()V
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;)Z
    ...
    invoke-virtual {v1, p0}, Landroid/support/v7/internal/view/menu/MenuBuilder;->a(Landroid/support/v7/internal/view/menu/h;)V
...
.method private b(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;Landroid/view/KeyEvent;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->n:Landroid/support/v7/internal/widget/t;

    if-eqz v4, :cond_6

    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->n:Landroid/support/v7/internal/widget/t;

    invoke-interface {v4}, Landroid/support/v7/internal/widget/t;->i()V
    ...
    iget-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/app/o;

    if-nez v4, :cond_9

    new-instance v4, Landroid/support/v7/app/o;

    invoke-direct {v4, p0, v7}, Landroid/support/v7/app/o;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/app/AppCompatDelegateImplV7$1;)V

    iput-object v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/app/o;
    ...
    iget-object v6, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/app/o;

    invoke-interface {v4, v5, v6}, Landroid/support/v7/internal/widget/t;->a(Landroid/view/Menu;Landroid/support/v7/internal/view/menu/u;)V
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->o:Landroid/support/v7/app/o;

    invoke-interface {v0, v7, v1}, Landroid/support/v7/internal/widget/t;->a(Landroid/view/Menu;Landroid/support/v7/internal/view/menu/u;)V
    ...
    invoke-virtual {v4, v5}, Landroid/support/v7/internal/view/menu/MenuBuilder;->b(Landroid/os/Bundle;)V
...
.method private c(Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;)Z
    ...
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->p:Landroid/support/v7/app/r;
    ...
    invoke-direct {v0, p0, v3}, Landroid/support/v7/app/r;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/app/AppCompatDelegateImplV7$1;)V

    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->p:Landroid/support/v7/app/r;

    :cond_2
    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->p:Landroid/support/v7/app/r;

    invoke-virtual {p1, v0}, Landroid/support/v7/app/AppCompatDelegateImplV7$PanelFeatureState;->a(Landroid/support/v7/internal/view/menu/u;)Landroid/support/v7/internal/view/menu/v;
...
.method private e(I)V
    ...
    invoke-virtual {v2, v1}, Landroid/support/v7/internal/view/menu/MenuBuilder;->a(Landroid/os/Bundle;)V
...
.method private e(ILandroid/view/KeyEvent;)V
    ...
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->j:Landroid/support/v7/b/a;
    ...
    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->n:Landroid/support/v7/internal/widget/t;

    if-eqz v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->n:Landroid/support/v7/internal/widget/t;

    invoke-interface {v2}, Landroid/support/v7/internal/widget/t;->d()Z
    ...
    invoke-static {v2}, Landroid/support/v4/view/cv;->b(Landroid/view/ViewConfiguration;)Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/t;->h()Z
...
.method private f(I)I
    ...
    invoke-static {v5, v1, v4}, Landroid/support/v7/internal/widget/ar;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method private o()V
    ...
    iput-boolean v4, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->e:Z
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->n:Landroid/support/v7/internal/widget/t;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/t;->setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/t;->a(I)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/cb;->a(Landroid/view/View;Landroid/support/v4/view/bn;)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/w;->setOnFitSystemWindowsListener(Landroid/support/v7/internal/widget/x;)V
    ...
    invoke-static {v0}, Landroid/support/v7/internal/widget/ar;->b(Landroid/view/View;)V
...
.method a(Landroid/support/v7/b/b;)Landroid/support/v7/b/a;
    ...
    invoke-direct {v4, p0, p1}, Landroid/support/v7/app/p;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/b/b;)V

    iget-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->d:Landroid/support/v7/app/h;
    ...
    invoke-interface {v0, v4}, Landroid/support/v7/app/h;->a(Landroid/support/v7/b/b;)Landroid/support/v7/b/a;
    :try_end_0
    ...
    iput-object v0, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->j:Landroid/support/v7/b/a;
    ...
    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->j:Landroid/support/v7/b/a;

    invoke-interface {v0, v1}, Landroid/support/v7/app/h;->a(Landroid/support/v7/b/a;)V
    ...
    iput-object v6, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->k:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    iput-object v6, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->l:Landroid/widget/PopupWindow;

    iget-object v6, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->l:Landroid/widget/PopupWindow;

    iget-object v7, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->k:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    iget-object v5, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->k:Landroid/support/v7/internal/widget/ActionBarContextView;
    ...
    :goto_4
    invoke-direct {v5, v6, v7, v4, v0}, Landroid/support/v7/internal/view/c;-><init>(Landroid/content/Context;Landroid/support/v7/internal/widget/ActionBarContextView;Landroid/support/v7/b/b;Z)V
    ...
    iput-object v5, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->j:Landroid/support/v7/b/a;
    ...
    :cond_9
    iput-object v3, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->j:Landroid/support/v7/b/a;
...
.method public a(Landroid/os/Bundle;)V
    ...
    invoke-static {v0}, Landroid/support/v4/app/af;->b(Landroid/app/Activity;)Ljava/lang/String;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->i()Landroid/support/v7/app/ActionBar;
...
.method a(ILandroid/view/Menu;)Z
    ...
    invoke-virtual {v2, v1}, Landroid/support/v7/app/ActionBar;->e(Z)V
...
.method public b(Landroid/support/v7/b/b;)Landroid/support/v7/b/a;
    ...
    invoke-direct {v0, p0, p1}, Landroid/support/v7/app/p;-><init>(Landroid/support/v7/app/AppCompatDelegateImplV7;Landroid/support/v7/b/b;)V
    ...
    iput-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->j:Landroid/support/v7/b/a;

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->j:Landroid/support/v7/b/a;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/app/AppCompatDelegateImplV7;->d:Landroid/support/v7/app/h;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/app/h;->a(Landroid/support/v7/b/a;)V
    ...
    invoke-virtual {p0, v0}, Landroid/support/v7/app/AppCompatDelegateImplV7;->a(Landroid/support/v7/b/b;)Landroid/support/v7/b/a;
...
.method b(Ljava/lang/CharSequence;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/t;->setWindowTitle(Ljava/lang/CharSequence;)V
...
.method public c(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-static {p1}, Landroid/support/v4/view/cb;->y(Landroid/view/View;)Z
...
.method public h()Landroid/support/v7/app/ActionBar;
    ...
    invoke-direct {v1, v0, v2}, Landroid/support/v7/internal/a/d;-><init>(Landroid/app/Activity;Z)V
    ...
    invoke-direct {v1, v0}, Landroid/support/v7/internal/a/d;-><init>(Landroid/app/Dialog;)V
