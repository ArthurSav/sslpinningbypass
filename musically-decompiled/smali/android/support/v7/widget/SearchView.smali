...
# static fields
.field static final a:Landroid/support/v7/widget/bj;
...
.field private u:Landroid/support/v7/widget/bk;

.field private v:Landroid/view/View$OnFocusChangeListener;

.field private w:Landroid/support/v7/widget/bm;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/bj;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1, p2, v0, p3, v6}, Landroid/support/v7/internal/widget/ao;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/ao;

    move-result-object v1

    invoke-virtual {v1}, Landroid/support/v7/internal/widget/ao;->c()Landroid/support/v7/internal/widget/am;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/SearchView;->N:Landroid/support/v7/internal/widget/am;
    ...
    invoke-virtual {v1, v2, v3}, Landroid/support/v7/internal/widget/ao;->f(II)I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/internal/widget/ao;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v7/internal/widget/ao;->f(II)I
    ...
    invoke-virtual {v1, v0, v6}, Landroid/support/v7/internal/widget/ao;->f(II)I
    ...
    invoke-virtual {v1, v0, v5}, Landroid/support/v7/internal/widget/ao;->a(IZ)Z
    ...
    invoke-virtual {v1, v0, v4}, Landroid/support/v7/internal/widget/ao;->d(II)I
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/internal/widget/ao;->c(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v1, v0, v4}, Landroid/support/v7/internal/widget/ao;->a(II)I
    ...
    invoke-virtual {v1}, Landroid/support/v7/internal/widget/ao;->b()V
...
.method private a(I)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->w:Landroid/support/v7/widget/bm;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->w:Landroid/support/v7/widget/bm;

    invoke-interface {v0, p1}, Landroid/support/v7/widget/bm;->a(I)Z
...
.method private a(IILjava/lang/String;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->w:Landroid/support/v7/widget/bm;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->w:Landroid/support/v7/widget/bm;

    invoke-interface {v1, p1}, Landroid/support/v7/widget/bm;->b(I)Z
...
.method private a(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/bj;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->d:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1, v2}, Landroid/support/v7/widget/bj;->a(Landroid/widget/AutoCompleteTextView;Z)V
...
.method private c(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/support/v7/widget/bl;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/bl;->b(Ljava/lang/String;)Z
...
.method private o()V
    ...
    invoke-direct {v0, v2, p0, v3, v4}, Landroid/support/v7/widget/bq;-><init>(Landroid/content/Context;Landroid/support/v7/widget/SearchView;Landroid/app/SearchableInfo;Ljava/util/WeakHashMap;)V
...
.method private p()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/support/v7/widget/bl;
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/bl;->a(Ljava/lang/String;)Z
...
.method private r()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->u:Landroid/support/v7/widget/bk;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/SearchView;->u:Landroid/support/v7/widget/bk;

    invoke-interface {v0}, Landroid/support/v7/widget/bk;->a()Z
...
.method private v()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bj;->a(Landroid/widget/AutoCompleteTextView;)V

    sget-object v0, Landroid/support/v7/widget/SearchView;->a:Landroid/support/v7/widget/bj;

    iget-object v1, p0, Landroid/support/v7/widget/SearchView;->d:Landroid/support/v7/widget/SearchView$SearchAutoComplete;

    invoke-virtual {v0, v1}, Landroid/support/v7/widget/bj;->b(Landroid/widget/AutoCompleteTextView;)V
...
.method public setOnCloseListener(Landroid/support/v7/widget/bk;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->u:Landroid/support/v7/widget/bk;
...
.method public setOnQueryTextListener(Landroid/support/v7/widget/bl;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->t:Landroid/support/v7/widget/bl;
...
.method public setOnSuggestionListener(Landroid/support/v7/widget/bm;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/widget/SearchView;->w:Landroid/support/v7/widget/bm;
