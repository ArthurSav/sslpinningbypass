...
.method public constructor <init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/internal/view/menu/SubMenuBuilder;)V
    ...
    iput-object p3, p0, Landroid/support/v7/widget/a;->d:Landroid/support/v7/internal/view/menu/SubMenuBuilder;
    ...
    invoke-static {p1}, Landroid/support/v7/widget/ActionMenuPresenter;->e(Landroid/support/v7/widget/ActionMenuPresenter;)Landroid/support/v7/internal/view/menu/v;
    ...
    :goto_0
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/a;->a(Landroid/view/View;)V

    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/ActionMenuPresenter;->g:Landroid/support/v7/widget/f;

    invoke-virtual {p0, v0}, Landroid/support/v7/widget/a;->a(Landroid/support/v7/internal/view/menu/u;)V
    ...
    :cond_1
    invoke-virtual {p0, v4}, Landroid/support/v7/widget/a;->a(Z)V
...
.method public onDismiss()V
    ...
    invoke-super {p0}, Landroid/support/v7/internal/view/menu/r;->onDismiss()V

    iget-object v0, p0, Landroid/support/v7/widget/a;->c:Landroid/support/v7/widget/ActionMenuPresenter;

    const/4 v1, 0x0

    invoke-static {v0, v1}, Landroid/support/v7/widget/ActionMenuPresenter;->a(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/support/v7/widget/a;)Landroid/support/v7/widget/a;
