...
.field private final v:Landroid/support/v7/widget/ag;

.field private final w:Landroid/support/v7/widget/af;

.field private final x:Landroid/support/v7/widget/ae;

.field private final y:Landroid/support/v7/widget/ac;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ag;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Landroid/support/v7/widget/ag;

    new-instance v0, Landroid/support/v7/widget/af;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/af;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->w:Landroid/support/v7/widget/af;

    new-instance v0, Landroid/support/v7/widget/ae;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ae;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->x:Landroid/support/v7/widget/ae;

    new-instance v0, Landroid/support/v7/widget/ac;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ac;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V

    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->y:Landroid/support/v7/widget/ac;
    ...
    invoke-static {v0}, Landroid/support/v4/c/q;->a(Ljava/util/Locale;)I
...
.method static synthetic a(Landroid/support/v7/widget/ListPopupWindow;)Landroid/support/v7/widget/y;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/y;
...
.method static synthetic c(Landroid/support/v7/widget/ListPopupWindow;)Landroid/support/v7/widget/ag;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Landroid/support/v7/widget/ag;
...
.method private i()I
    ...
    :goto_0
    invoke-direct {v4, v5, v0}, Landroid/support/v7/widget/y;-><init>(Landroid/content/Context;Z)V

    iput-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/y;
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/y;->setSelector(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/y;->setAdapter(Landroid/widget/ListAdapter;)V

    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/y;

    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->t:Landroid/widget/AdapterView$OnItemClickListener;

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/y;->setOnItemClickListener(Landroid/widget/AdapterView$OnItemClickListener;)V
    ...
    invoke-virtual {v0, v4}, Landroid/support/v7/widget/y;->setOnItemSelectedListener(Landroid/widget/AdapterView$OnItemSelectedListener;)V

    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/y;

    iget-object v4, p0, Landroid/support/v7/widget/ListPopupWindow;->x:Landroid/support/v7/widget/ae;

    invoke-virtual {v0, v4}, Landroid/support/v7/widget/y;->setOnScrollListener(Landroid/widget/AbsListView$OnScrollListener;)V
...
.method public a()V
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/y;

    iget-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->A:Landroid/os/Handler;

    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->v:Landroid/support/v7/widget/ag;
...
.method public a(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ad;-><init>(Landroid/support/v7/widget/ListPopupWindow;Landroid/support/v7/widget/ListPopupWindow$1;)V
...
.method public c()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->w:Landroid/support/v7/widget/af;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->f:Landroid/support/v7/widget/y;

    invoke-virtual {v1, v0}, Landroid/support/v7/widget/y;->setSelection(I)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->y:Landroid/support/v7/widget/ac;
...
.method public d(I)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ListPopupWindow;->c(I)V
...
.method public e()V
    ...
    invoke-static {v0, v1}, Landroid/support/v7/widget/y;->a(Landroid/support/v7/widget/y;Z)Z
