...
.method private constructor <init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/bs;->c:Landroid/support/v7/widget/Toolbar;
...
.method synthetic constructor <init>(Landroid/support/v7/widget/Toolbar;Landroid/support/v7/widget/Toolbar$1;)V
    ...
    invoke-direct {p0, p1}, Landroid/support/v7/widget/bs;-><init>(Landroid/support/v7/widget/Toolbar;)V
...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/MenuBuilder;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bs;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bs;->b:Landroid/support/v7/internal/view/menu/MenuItemImpl;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/bs;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;

    iget-object v1, p0, Landroid/support/v7/widget/bs;->b:Landroid/support/v7/internal/view/menu/MenuItemImpl;
    ...
    :cond_0
    iput-object p2, p0, Landroid/support/v7/widget/bs;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;
...
.method public a(Landroid/support/v7/internal/view/menu/MenuBuilder;Landroid/support/v7/internal/view/menu/MenuItemImpl;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/widget/bs;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bs;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iput-object p2, p0, Landroid/support/v7/widget/bs;->b:Landroid/support/v7/internal/view/menu/MenuItemImpl;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/bs;->c:Landroid/support/v7/widget/Toolbar;
...
.method public b(Z)V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/bs;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;
    ...
    iget-object v3, p0, Landroid/support/v7/widget/bs;->a:Landroid/support/v7/internal/view/menu/MenuBuilder;

    invoke-virtual {v3, v1}, Landroid/support/v7/internal/view/menu/MenuBuilder;->getItem(I)Landroid/view/MenuItem;

    move-result-object v3

    iget-object v4, p0, Landroid/support/v7/widget/bs;->b:Landroid/support/v7/internal/view/menu/MenuItemImpl;
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/bs;->b(Landroid/support/v7/internal/view/menu/MenuBuilder;Landroid/support/v7/internal/view/menu/MenuItemImpl;)Z
...
.method public b(Landroid/support/v7/internal/view/menu/MenuBuilder;Landroid/support/v7/internal/view/menu/MenuItemImpl;)Z
    ...
    iput-object v3, p0, Landroid/support/v7/widget/bs;->b:Landroid/support/v7/internal/view/menu/MenuItemImpl;
