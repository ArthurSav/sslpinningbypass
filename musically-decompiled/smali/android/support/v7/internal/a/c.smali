...
.method private static a(Landroid/content/Context;Landroid/support/v4/app/ba;)Landroid/widget/RemoteViews;
    .locals 4

    invoke-virtual {p1}, Landroid/support/v4/app/ba;->c()Landroid/app/PendingIntent;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/ba;->a()I
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/ba;->b()Ljava/lang/CharSequence;
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v14}, Landroid/support/v7/internal/a/c;->a(I)I
    ...
    check-cast v2, Landroid/support/v4/app/ba;

    move-object/from16 v0, p0

    invoke-static {v0, v2}, Landroid/support/v7/internal/a/c;->a(Landroid/content/Context;Landroid/support/v4/app/ba;)Landroid/widget/RemoteViews;
...
.method private static a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
    ...
    invoke-static {p0, v2}, Landroid/support/v7/internal/a/c;->a(Landroid/content/Context;Landroid/support/v4/app/ba;)Landroid/widget/RemoteViews;
...
.method public static a(Landroid/app/Notification;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)V
    ...
    invoke-static/range {p1 .. p13}, Landroid/support/v7/internal/a/c;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;ZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
...
.method public static a(Landroid/support/v4/app/al;Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    invoke-static/range {p1 .. p14}, Landroid/support/v7/internal/a/c;->a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;ILandroid/graphics/Bitmap;Ljava/lang/CharSequence;ZJLjava/util/List;[IZLandroid/app/PendingIntent;)Landroid/widget/RemoteViews;
