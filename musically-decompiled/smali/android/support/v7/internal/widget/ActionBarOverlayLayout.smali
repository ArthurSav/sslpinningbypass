...
# instance fields
.field private final A:Landroid/support/v4/view/eo;

.field private final B:Landroid/support/v4/view/eo;
...
.field private g:Landroid/support/v7/internal/widget/u;
...
.field private v:Landroid/support/v7/internal/widget/d;

.field private final w:I

.field private x:Landroid/support/v4/widget/ai;

.field private y:Landroid/support/v4/view/eb;

.field private z:Landroid/support/v4/view/eb;
...
.method static synthetic a(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/view/eb;)Landroid/support/v4/view/eb;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/view/eb;

    return-object p1
.end method

.method private a(Landroid/view/View;)Landroid/support/v7/internal/widget/u;
    .locals 3
...
.method private a(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Landroid/support/v4/widget/ai;->a(Landroid/content/Context;)Landroid/support/v4/widget/ai;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/widget/ai;
...
.method private a(FF)Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->x:Landroid/support/v4/widget/ai;
...
.method static synthetic b(Landroid/support/v7/internal/widget/ActionBarOverlayLayout;Landroid/support/v4/view/eb;)Landroid/support/v4/view/eb;
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->z:Landroid/support/v4/view/eb;
...
.method private k()V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->y:Landroid/support/v4/view/eb;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->z:Landroid/support/v4/view/eb;
...
.method public a(I)V
    ...
    :sswitch_0
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->g:Landroid/support/v7/internal/widget/u;

    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->g()V
...
.method public a(Landroid/view/Menu;Landroid/support/v7/internal/view/menu/u;)V
    .locals 1
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/internal/widget/u;->a(Landroid/view/Menu;Landroid/support/v7/internal/view/menu/u;)V
...
.method c()V
    ...
    invoke-direct {p0, v0}, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->a(Landroid/view/View;)Landroid/support/v7/internal/widget/u;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->g:Landroid/support/v7/internal/widget/u;
...
.method public d()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->i()Z
...
.method public e()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->j()Z
...
.method public f()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->k()Z
...
.method protected fitSystemWindows(Landroid/graphics/Rect;)Z
    ...
    invoke-static {p0, v1, v2}, Landroid/support/v7/internal/widget/ar;->a(Landroid/view/View;Landroid/graphics/Rect;Landroid/graphics/Rect;)V
...
.method public g()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->l()Z
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->f()Ljava/lang/CharSequence;
...
.method public h()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->m()Z
...
.method public i()V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->n()V
...
.method public j()V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/u;->o()V
...
.method protected onMeasure(II)V
    ...
    invoke-static {v6, v0}, Landroid/support/v7/internal/widget/ar;->a(II)I
    ...
    :cond_0
    :goto_2
    iget-object v1, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->g:Landroid/support/v7/internal/widget/u;

    invoke-interface {v1}, Landroid/support/v7/internal/widget/u;->c()Z
    ...
    invoke-static {v7, v2}, Landroid/support/v7/internal/widget/ar;->a(II)I
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->v:Landroid/support/v7/internal/widget/d;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->v:Landroid/support/v7/internal/widget/d;

    invoke-interface {v0}, Landroid/support/v7/internal/widget/d;->i()V
...
.method public onStopNestedScroll(Landroid/view/View;)V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/d;->j()V
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    :goto_1
    iget-object v5, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->v:Landroid/support/v7/internal/widget/d;
    ...
    :goto_2
    invoke-interface {v5, v1}, Landroid/support/v7/internal/widget/d;->g(Z)V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/d;->g()V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/d;->h()V
...
.method public setActionBarHideOffset(I)V
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/cb;->b(Landroid/view/View;F)V
...
.method public setActionBarVisibilityCallback(Landroid/support/v7/internal/widget/d;)V
    .locals 2

    iput-object p1, p0, Landroid/support/v7/internal/widget/ActionBarOverlayLayout;->v:Landroid/support/v7/internal/widget/d;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/d;->a(I)V
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/u;->a(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/u;->a(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/u;->b(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/widget/u;->a(Landroid/view/Window$Callback;)V
