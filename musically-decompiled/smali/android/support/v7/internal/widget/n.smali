...
.field private e:Landroid/support/v7/internal/widget/s;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "<TT;>.android/support/v7/internal/widget/s;"
        }
    .end annotation
.end field
...
.field r:Landroid/support/v7/internal/widget/r;

.field s:Landroid/support/v7/internal/widget/p;

.field t:Landroid/support/v7/internal/widget/q;
...
.method private a()V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/n;->r:Landroid/support/v7/internal/widget/r;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v7/internal/widget/r;->a(Landroid/support/v7/internal/widget/n;Landroid/view/View;IJ)V
    ...
    invoke-interface {v0, p0}, Landroid/support/v7/internal/widget/r;->a(Landroid/support/v7/internal/widget/n;)V
...
.method public a(Landroid/view/View;IJ)Z
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/widget/n;->s:Landroid/support/v7/internal/widget/p;
    ...
    invoke-interface/range {v0 .. v5}, Landroid/support/v7/internal/widget/p;->a(Landroid/support/v7/internal/widget/n;Landroid/view/View;IJ)V
...
.method f()V
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/widget/n;->e:Landroid/support/v7/internal/widget/s;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/internal/widget/s;-><init>(Landroid/support/v7/internal/widget/n;Landroid/support/v7/internal/widget/n$1;)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/n;->e:Landroid/support/v7/internal/widget/s;
...
.method g()V
    ...
    invoke-virtual {p0, v0, v2}, Landroid/support/v7/internal/widget/n;->b(IZ)I
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/internal/widget/n;->b(IZ)I
...
.method public final getOnItemClickListener()Landroid/support/v7/internal/widget/p;
    .locals 1
...
.method public final getOnItemLongClickListener()Landroid/support/v7/internal/widget/q;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/widget/n;->t:Landroid/support/v7/internal/widget/q;

    return-object v0
.end method

.method public final getOnItemSelectedListener()Landroid/support/v7/internal/widget/r;
    .locals 1
...
.method public setOnItemLongClickListener(Landroid/support/v7/internal/widget/q;)V
    .locals 1
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v7/internal/widget/n;->t:Landroid/support/v7/internal/widget/q;

    return-void
.end method

.method public setOnItemSelectedListener(Landroid/support/v7/internal/widget/r;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/internal/widget/n;->r:Landroid/support/v7/internal/widget/r;
