...
.field private final L:Landroid/support/v7/internal/widget/am;
...
.method constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-static {p1, p2, v0, p3, v4}, Landroid/support/v7/internal/widget/ao;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/internal/widget/ao;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/internal/widget/ao;->a(II)I

    move-result v1

    iput v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->I:I

    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/ah;

    sget v2, Landroid/support/v7/appcompat/R$styleable;->Spinner_prompt:I

    invoke-virtual {v0, v2}, Landroid/support/v7/internal/widget/ao;->d(I)Ljava/lang/String;

    move-result-object v2

    invoke-interface {v1, v2}, Landroid/support/v7/internal/widget/ah;->a(Ljava/lang/CharSequence;)V

    sget v1, Landroid/support/v7/appcompat/R$styleable;->Spinner_disableChildrenWhenDisabled:I

    invoke-virtual {v0, v1, v4}, Landroid/support/v7/internal/widget/ao;->a(IZ)Z
    ...
    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/af;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/ah;

    iget-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/af;

    invoke-interface {v1, v2}, Landroid/support/v7/internal/widget/ah;->a(Landroid/widget/ListAdapter;)V

    iput-object v5, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/af;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->L:Landroid/support/v7/internal/widget/am;
    ...
    invoke-direct {v1, p0, v5}, Landroid/support/v7/internal/widget/ae;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/support/v7/internal/widget/SpinnerCompat$1;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/ah;
    ...
    invoke-direct {v1, p0, p1, p2, p3}, Landroid/support/v7/internal/widget/ag;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/content/Context;Landroid/util/AttributeSet;I)V

    sget v2, Landroid/support/v7/appcompat/R$styleable;->Spinner_android_dropDownWidth:I

    const/4 v3, -0x2

    invoke-virtual {v0, v2, v3}, Landroid/support/v7/internal/widget/ao;->e(II)I
    ...
    invoke-virtual {v1, v2}, Landroid/support/v7/internal/widget/ag;->a(Landroid/graphics/drawable/Drawable;)V

    iput-object v1, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/ah;

    new-instance v2, Landroid/support/v7/internal/widget/SpinnerCompat$1;

    invoke-direct {v2, p0, p0, v1}, Landroid/support/v7/internal/widget/SpinnerCompat$1;-><init>(Landroid/support/v7/internal/widget/SpinnerCompat;Landroid/view/View;Landroid/support/v7/internal/widget/ag;)V

    iput-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/z;
...
.method static synthetic a(Landroid/support/v7/internal/widget/SpinnerCompat;)Landroid/support/v7/internal/widget/ah;
    .locals 1

    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->G:Landroid/support/v7/internal/widget/ah;
...
.method private c(IZ)Landroid/view/View;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->i:Landroid/support/v7/internal/widget/a;
...
.method a(Landroid/support/v7/internal/widget/p;)V
    .locals 0

    invoke-super {p0, p1}, Landroid/support/v7/internal/widget/AbsSpinnerCompat;->setOnItemClickListener(Landroid/support/v7/internal/widget/p;)V
...
.method public a(Landroid/widget/SpinnerAdapter;)V
    ...
    invoke-direct {v1, p1}, Landroid/support/v7/internal/widget/af;-><init>(Landroid/widget/SpinnerAdapter;)V

    invoke-interface {v0, v1}, Landroid/support/v7/internal/widget/ah;->a(Landroid/widget/ListAdapter;)V
    ...
    invoke-direct {v0, p1}, Landroid/support/v7/internal/widget/af;-><init>(Landroid/widget/SpinnerAdapter;)V

    iput-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->H:Landroid/support/v7/internal/widget/af;
...
.method public getBaseline()I
    ...
    iget-object v2, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->i:Landroid/support/v7/internal/widget/a;
...
.method protected onDetachedFromWindow()V
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/ah;->b()Z
    ...
    invoke-interface {v0}, Landroid/support/v7/internal/widget/ah;->a()V
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/SpinnerCompat;->F:Landroid/support/v7/widget/z;
...
.method public performClick()Z
    ...
    invoke-interface {v1}, Landroid/support/v7/internal/widget/ah;->b()Z
    ...
    invoke-interface {v1}, Landroid/support/v7/internal/widget/ah;->c()V
...
.method public setOnItemClickListener(Landroid/support/v7/internal/widget/p;)V
    .locals 2
