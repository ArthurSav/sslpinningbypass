...
.field private b:Landroid/support/v7/internal/widget/e;
...
.method private constructor <init>(Landroid/support/v7/internal/widget/ActivityChooserView;)V
    ...
    iput-object p1, p0, Landroid/support/v7/internal/widget/l;->a:Landroid/support/v7/internal/widget/ActivityChooserView;

    invoke-direct {p0}, Landroid/widget/BaseAdapter;-><init>()V

    const/4 v0, 0x4

    iput v0, p0, Landroid/support/v7/internal/widget/l;->c:I
...
.method public a()I
    ...
    iget v4, p0, Landroid/support/v7/internal/widget/l;->c:I
    ...
    :cond_0
    iput v4, p0, Landroid/support/v7/internal/widget/l;->c:I
...
.method public a(Landroid/support/v7/internal/widget/e;)V
    .locals 2

    iget-object v0, p0, Landroid/support/v7/internal/widget/l;->a:Landroid/support/v7/internal/widget/ActivityChooserView;
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/l;->e()Landroid/support/v7/internal/widget/e;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v1, p0, Landroid/support/v7/internal/widget/l;->a:Landroid/support/v7/internal/widget/ActivityChooserView;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v7/internal/widget/e;->unregisterObserver(Ljava/lang/Object;)V

    :cond_0
    iput-object p1, p0, Landroid/support/v7/internal/widget/l;->b:Landroid/support/v7/internal/widget/e;
    ...
    invoke-virtual {p1, v0}, Landroid/support/v7/internal/widget/e;->registerObserver(Ljava/lang/Object;)V
...
.method public a(Z)V
    ...
    iput-boolean p1, p0, Landroid/support/v7/internal/widget/l;->f:Z
...
.method public a(ZZ)V
    ...
    iget-boolean v0, p0, Landroid/support/v7/internal/widget/l;->e:Z
    ...
    iput-boolean p2, p0, Landroid/support/v7/internal/widget/l;->e:Z
...
.method public b()Landroid/content/pm/ResolveInfo;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/widget/l;->b:Landroid/support/v7/internal/widget/e;

    invoke-virtual {v0}, Landroid/support/v7/internal/widget/e;->b()Landroid/content/pm/ResolveInfo;
...
.method public c()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/e;->a()I
...
.method public d()I
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/widget/e;->c()I
...
.method public e()Landroid/support/v7/internal/widget/e;
    .locals 1
...
.method public getCount()I
    ...
    iget-boolean v1, p0, Landroid/support/v7/internal/widget/l;->d:Z

    if-nez v1, :cond_0

    iget-object v1, p0, Landroid/support/v7/internal/widget/l;->b:Landroid/support/v7/internal/widget/e;

    invoke-virtual {v1}, Landroid/support/v7/internal/widget/e;->b()Landroid/content/pm/ResolveInfo;
    ...
    :cond_0
    iget v1, p0, Landroid/support/v7/internal/widget/l;->c:I
...
.method public getItem(I)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/internal/widget/e;->a(I)Landroid/content/pm/ResolveInfo;
...
.method public getView(ILandroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    invoke-static {p2, v5}, Landroid/support/v4/view/cb;->b(Landroid/view/View;Z)V

    goto :goto_0

    :cond_4
    invoke-static {p2, v4}, Landroid/support/v4/view/cb;->b(Landroid/view/View;Z)V
