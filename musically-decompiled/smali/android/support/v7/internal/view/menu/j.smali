...
.field private d:Landroid/support/v7/internal/view/menu/u;
...
.method public constructor <init>(Landroid/support/v7/internal/view/menu/MenuBuilder;)V
    ...
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/j;->b:Landroid/support/v7/internal/view/menu/MenuBuilder;
...
.method public a()V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/j;->c:Landroid/support/v7/app/AlertDialog;
...
.method public a(Landroid/os/IBinder;)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/j;->b:Landroid/support/v7/internal/view/menu/MenuBuilder;
    ...
    iput-object v2, p0, Landroid/support/v7/internal/view/menu/j;->a:Landroid/support/v7/internal/view/menu/f;

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/j;->a:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v2, p0}, Landroid/support/v7/internal/view/menu/f;->a(Landroid/support/v7/internal/view/menu/u;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/j;->b:Landroid/support/v7/internal/view/menu/MenuBuilder;

    iget-object v3, p0, Landroid/support/v7/internal/view/menu/j;->a:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v2, v3}, Landroid/support/v7/internal/view/menu/MenuBuilder;->a(Landroid/support/v7/internal/view/menu/t;)V

    iget-object v2, p0, Landroid/support/v7/internal/view/menu/j;->a:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v2}, Landroid/support/v7/internal/view/menu/f;->a()Landroid/widget/ListAdapter;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/j;->c:Landroid/support/v7/app/AlertDialog;
...
.method public a(Landroid/support/v7/internal/view/menu/MenuBuilder;Z)V
    ...
    :cond_0
    invoke-virtual {p0}, Landroid/support/v7/internal/view/menu/j;->a()V

    :cond_1
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/j;->d:Landroid/support/v7/internal/view/menu/u;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/j;->b:Landroid/support/v7/internal/view/menu/MenuBuilder;

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/j;->a:Landroid/support/v7/internal/view/menu/f;

    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/f;->a()Landroid/widget/ListAdapter;
...
.method public onKey(Landroid/content/DialogInterface;ILandroid/view/KeyEvent;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/internal/view/menu/j;->c:Landroid/support/v7/app/AlertDialog;
