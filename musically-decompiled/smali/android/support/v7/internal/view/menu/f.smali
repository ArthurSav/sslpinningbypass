...
.field g:Landroid/support/v7/internal/view/menu/g;
...
.method public constructor <init>(II)V
    ...
    iput p1, p0, Landroid/support/v7/internal/view/menu/f;->f:I

    iput p2, p0, Landroid/support/v7/internal/view/menu/f;->e:I
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/f;->a:Landroid/content/Context;

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->a:Landroid/content/Context;

    invoke-static {v0}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->b:Landroid/view/LayoutInflater;
...
.method static synthetic a(Landroid/support/v7/internal/view/menu/f;)I
    ...
    iget v0, p0, Landroid/support/v7/internal/view/menu/f;->h:I
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/internal/view/menu/v;
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->d:Landroid/support/v7/internal/view/menu/ExpandedMenuView;

    if-nez v0, :cond_1

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->b:Landroid/view/LayoutInflater;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->d:Landroid/support/v7/internal/view/menu/ExpandedMenuView;

    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->g:Landroid/support/v7/internal/view/menu/g;
    ...
    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->g:Landroid/support/v7/internal/view/menu/g;

    :cond_0
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->d:Landroid/support/v7/internal/view/menu/ExpandedMenuView;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/f;->g:Landroid/support/v7/internal/view/menu/g;
...
.method public a(Landroid/content/Context;Landroid/support/v7/internal/view/menu/MenuBuilder;)V
    ...
    iget v0, p0, Landroid/support/v7/internal/view/menu/f;->e:I

    if-eqz v0, :cond_2

    new-instance v0, Landroid/view/ContextThemeWrapper;

    iget v1, p0, Landroid/support/v7/internal/view/menu/f;->e:I

    invoke-direct {v0, p1, v1}, Landroid/view/ContextThemeWrapper;-><init>(Landroid/content/Context;I)V

    iput-object v0, p0, Landroid/support/v7/internal/view/menu/f;->a:Landroid/content/Context;
    ...
    :cond_0
    :goto_0
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/f;->c:Landroid/support/v7/internal/view/menu/MenuBuilder;
...
.method public a(Landroid/support/v7/internal/view/menu/MenuBuilder;Z)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->i:Landroid/support/v7/internal/view/menu/u;
...
.method public a(Landroid/support/v7/internal/view/menu/u;)V
    ...
    iput-object p1, p0, Landroid/support/v7/internal/view/menu/f;->i:Landroid/support/v7/internal/view/menu/u;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/f;->c:Landroid/support/v7/internal/view/menu/MenuBuilder;
    ...
    invoke-virtual {v0, v1, p0, v2}, Landroid/support/v7/internal/view/menu/MenuBuilder;->a(Landroid/view/MenuItem;Landroid/support/v7/internal/view/menu/t;I)Z
