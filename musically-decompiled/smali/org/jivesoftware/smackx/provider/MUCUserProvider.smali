...
.method private parseDecline(Lorg/xmlpull/v1/XmlPullParser;)Lorg/jivesoftware/smackx/packet/MUCUser$Decline;
    ...
    new-instance v3, Lorg/jivesoftware/smackx/packet/MUCUser$Decline;

    invoke-direct {v3}, Lorg/jivesoftware/smackx/packet/MUCUser$Decline;-><init>()V
    ...
    invoke-virtual {v3, v0}, Lorg/jivesoftware/smackx/packet/MUCUser$Decline;->setFrom(Ljava/lang/String;)V
    ...
    invoke-virtual {v3, v0}, Lorg/jivesoftware/smackx/packet/MUCUser$Decline;->setTo(Ljava/lang/String;)V

    const-string v0, ""

    const-string v4, "fromNick"

    invoke-interface {p1, v0, v4}, Lorg/xmlpull/v1/XmlPullParser;->getAttributeValue(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v3, v0}, Lorg/jivesoftware/smackx/packet/MUCUser$Decline;->setFromNick(Ljava/lang/String;)V
    ...
    sget-object v4, Lorg/jivesoftware/smackx/packet/MUCUser$MucType;->Apply:Lorg/jivesoftware/smackx/packet/MUCUser$MucType;

    invoke-virtual {v4}, Lorg/jivesoftware/smackx/packet/MUCUser$MucType;->toString()Ljava/lang/String;
    ...
    :cond_0
    invoke-static {v0}, Lorg/jivesoftware/smackx/packet/MUCUser$MucType;->valueOf(Ljava/lang/String;)Lorg/jivesoftware/smackx/packet/MUCUser$MucType;

    move-result-object v0

    invoke-virtual {v3, v0}, Lorg/jivesoftware/smackx/packet/MUCUser$Decline;->setType(Lorg/jivesoftware/smackx/packet/MUCUser$MucType;)V
    ...
    invoke-virtual {v3, v1}, Lorg/jivesoftware/smackx/packet/MUCUser$Decline;->setReason(Ljava/lang/String;)V
