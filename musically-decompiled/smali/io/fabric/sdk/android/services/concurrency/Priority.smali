...
.method static a(Lio/fabric/sdk/android/services/concurrency/k;Ljava/lang/Object;)I
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<Y:",
    ...
    instance-of v0, p1, Lio/fabric/sdk/android/services/concurrency/k;

    if-eqz v0, :cond_0

    check-cast p1, Lio/fabric/sdk/android/services/concurrency/k;

    invoke-interface {p1}, Lio/fabric/sdk/android/services/concurrency/k;->b()Lio/fabric/sdk/android/services/concurrency/Priority;
    ...
    invoke-interface {p0}, Lio/fabric/sdk/android/services/concurrency/k;->b()Lio/fabric/sdk/android/services/concurrency/Priority;
