...
.method public constructor <init>(Landroid/content/Context;Lcom/twitter/sdk/android/core/internal/scribe/f;JLcom/twitter/sdk/android/core/TwitterAuthConfig;Ljava/util/List;Ljavax/net/ssl/SSLSocketFactory;Ljava/util/concurrent/ExecutorService;Lio/fabric/sdk/android/services/common/IdManager;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p9, p0, Lcom/twitter/sdk/android/core/internal/scribe/ScribeFilesSender;->l:Lio/fabric/sdk/android/services/common/IdManager;
...
.method private a(Lcom/twitter/sdk/android/core/l;)Z
    ...
    invoke-virtual {p1}, Lcom/twitter/sdk/android/core/l;->b()Lcom/twitter/sdk/android/core/c;
...
.method declared-synchronized a()Lretrofit/RestAdapter;
    ...
    iget-object v2, p0, Lcom/twitter/sdk/android/core/internal/scribe/ScribeFilesSender;->e:Lcom/twitter/sdk/android/core/internal/scribe/f;

    iget-object v3, p0, Lcom/twitter/sdk/android/core/internal/scribe/ScribeFilesSender;->l:Lio/fabric/sdk/android/services/common/IdManager;

    invoke-direct {v1, v2, v3}, Lcom/twitter/sdk/android/core/internal/scribe/j;-><init>(Lcom/twitter/sdk/android/core/internal/scribe/f;Lio/fabric/sdk/android/services/common/IdManager;)V
    ...
    invoke-direct {v4, v5, v0, v6}, Lcom/twitter/sdk/android/core/e;-><init>(Lcom/twitter/sdk/android/core/TwitterAuthConfig;Lcom/twitter/sdk/android/core/l;Ljavax/net/ssl/SSLSocketFactory;)V
...
.method a(Ljava/lang/String;)Lretrofit/client/Response;
    ...
    iget-object v1, p0, Lcom/twitter/sdk/android/core/internal/scribe/ScribeFilesSender;->e:Lcom/twitter/sdk/android/core/internal/scribe/f;

    iget-object v1, v1, Lcom/twitter/sdk/android/core/internal/scribe/f;->e:Ljava/lang/String;
    ...
    iget-object v1, v1, Lcom/twitter/sdk/android/core/internal/scribe/f;->c:Ljava/lang/String;

    iget-object v2, p0, Lcom/twitter/sdk/android/core/internal/scribe/ScribeFilesSender;->e:Lcom/twitter/sdk/android/core/internal/scribe/f;

    iget-object v2, v2, Lcom/twitter/sdk/android/core/internal/scribe/f;->d:Ljava/lang/String;
...
.method public a(Ljava/util/List;)Z
    ...
    invoke-static {v2, v1}, Lio/fabric/sdk/android/services/common/h;->a(Landroid/content/Context;Ljava/lang/String;)V
    ...
    invoke-static {v1, v2, v3}, Lio/fabric/sdk/android/services/common/h;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_0
    ...
    invoke-static {v2, v3, v1}, Lio/fabric/sdk/android/services/common/h;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method b(Ljava/util/List;)Ljava/lang/String;
    ...
    invoke-direct {v1, v0}, Lio/fabric/sdk/android/services/common/p;-><init>(Ljava/io/File;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-virtual {v1, v0}, Lio/fabric/sdk/android/services/common/p;->a(Lio/fabric/sdk/android/services/common/s;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1

    invoke-static {v1}, Lio/fabric/sdk/android/services/common/h;->a(Ljava/io/Closeable;)V
