...
.field private final mCachedBitmaps:Landroid/support/v4/util/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private final mDecodesInFlight:Landroid/support/v4/util/m;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/util/m",
            "<",
...
.method public constructor <init>(Lcom/facebook/common/executors/SerialExecutorService;Landroid/app/ActivityManager;Lcom/facebook/imagepipeline/animated/util/AnimatedDrawableUtil;Lcom/facebook/common/time/MonotonicClock;Lcom/facebook/imagepipeline/animated/base/AnimatedDrawableBackend;Lcom/facebook/imagepipeline/animated/base/AnimatedDrawableOptions;)V
    ...
    invoke-direct {v0, v2}, Landroid/support/v4/util/m;-><init>(I)V

    iput-object v0, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mDecodesInFlight:Landroid/support/v4/util/m;

    new-instance v0, Landroid/support/v4/util/m;

    invoke-direct {v0, v2}, Landroid/support/v4/util/m;-><init>(I)V

    iput-object v0, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mCachedBitmaps:Landroid/support/v4/util/m;
...
.method static synthetic access$300(Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;Lbolts/f;I)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->onFutureFinished(Lbolts/f;I)V
...
.method private declared-synchronized cancelFuturesOutsideOfRange(II)V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mDecodesInFlight:Landroid/support/v4/util/m;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/util/m;->e(I)I
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/util/m;->d(I)V
    :try_end_0
...
.method private declared-synchronized doPrefetch(II)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/util/m;->a(I)Ljava/lang/Object;
    ...
    invoke-static {v0, v3}, Lbolts/f;->a(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lbolts/f;

    move-result-object v0

    iget-object v3, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mDecodesInFlight:Landroid/support/v4/util/m;

    invoke-virtual {v3, v2, v0}, Landroid/support/v4/util/m;->b(ILjava/lang/Object;)V

    new-instance v3, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl$4;

    invoke-direct {v3, p0, v0, v2}, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl$4;-><init>(Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;Lbolts/f;I)V

    invoke-virtual {v0, v3}, Lbolts/f;->a(Lbolts/e;)Lbolts/f;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private declared-synchronized dropBitmapsThatShouldNotBeCached()V
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mCachedBitmaps:Landroid/support/v4/util/m;
    ...
    iget-object v2, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mCachedBitmaps:Landroid/support/v4/util/m;
...
.method private maybeCacheBitmapDuringRender(ILandroid/graphics/Bitmap;)V
    ...
    iget-object v1, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mCachedBitmaps:Landroid/support/v4/util/m;
...
.method private declared-synchronized maybeCacheRenderedBitmap(ILcom/facebook/common/references/CloseableReference;)V
    ...
    invoke-virtual {v0, p1, v1}, Landroid/support/v4/util/m;->b(ILjava/lang/Object;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private declared-synchronized onFutureFinished(Lbolts/f;I)V
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p2}, Landroid/support/v4/util/m;->g(I)I
...
.method private declared-synchronized schedulePrefetches()V
    ...
    iget-object v3, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mCachedBitmaps:Landroid/support/v4/util/m;

    invoke-virtual {v3, v0}, Landroid/support/v4/util/m;->a(I)Ljava/lang/Object;
...
.method declared-synchronized getDecodesInFlight()Ljava/util/Map;
    ...
    :goto_0
    iget-object v2, p0, Lcom/facebook/imagepipeline/animated/impl/AnimatedDrawableCachingBackendImpl;->mDecodesInFlight:Landroid/support/v4/util/m;

    invoke-virtual {v2}, Landroid/support/v4/util/m;->b()I
    ...
    invoke-virtual {v2, v0}, Landroid/support/v4/util/m;->e(I)I
    ...
    invoke-virtual {v3, v0}, Landroid/support/v4/util/m;->f(I)Ljava/lang/Object;
