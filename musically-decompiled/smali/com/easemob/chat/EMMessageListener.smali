...
.field protected previousPacketTime:J
...
.method public declared-synchronized processPacket(Lorg/jivesoftware/smack/packet/Packet;)V
    ...
    iget-wide v2, p0, Lcom/easemob/chat/EMMessageListener;->previousPacketTime:J
    ...
    iput-wide v0, p0, Lcom/easemob/chat/EMMessageListener;->previousPacketTime:J

    invoke-static {}, Lcom/easemob/chat/EMSessionManager;->getInstance()Lcom/easemob/chat/EMSessionManager;

    move-result-object v0

    invoke-virtual {v0}, Lcom/easemob/chat/EMSessionManager;->getWakeLock()Landroid/os/PowerManager$WakeLock;
    ...
    const-string v2, "temp acquire 3s"
