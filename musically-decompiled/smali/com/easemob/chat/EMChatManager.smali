...
.method private addPacketListeners(Lorg/jivesoftware/smack/XMPPConnection;)V
    ...
    sget-object v1, Lorg/jivesoftware/smack/packet/Message$Type;->notify:Lorg/jivesoftware/smack/packet/Message$Type;

    invoke-direct {v0, v1}, Lorg/jivesoftware/smack/filter/MessageTypeFilter;-><init>(Lorg/jivesoftware/smack/packet/Message$Type;)V

    new-instance v1, Lcom/easemob/chat/EMChatManager$4;

    invoke-direct {v1, p0}, Lcom/easemob/chat/EMChatManager$4;-><init>(Lcom/easemob/chat/EMChatManager;)V

    invoke-virtual {p1, v1, v0}, Lorg/jivesoftware/smack/XMPPConnection;->addPacketListener(Lorg/jivesoftware/smack/PacketListener;Lorg/jivesoftware/smack/filter/PacketFilter;)V

    new-instance v0, Lcom/easemob/chat/EMChatManager$5;

    const-class v1, Lorg/jivesoftware/smack/packet/Presence;

    invoke-direct {v0, p0, v1}, Lcom/easemob/chat/EMChatManager$5;-><init>(Lcom/easemob/chat/EMChatManager;Ljava/lang/Class;)V
...
.method private getInnerCallBack(Lcom/easemob/EMCallBack;Lcom/easemob/chat/EMMessage;)Lcom/easemob/EMCallBack;
    .locals 1

    new-instance v0, Lcom/easemob/chat/EMChatManager$6;

    invoke-direct {v0, p0, p1, p2}, Lcom/easemob/chat/EMChatManager$6;-><init>(Lcom/easemob/chat/EMChatManager;Lcom/easemob/EMCallBack;Lcom/easemob/chat/EMMessage;)V
...
.method public addConnectionListener(Lcom/easemob/EMConnectionListener;)V
    ...
    new-instance v1, Lcom/easemob/chat/EMChatManager$9;

    invoke-direct {v1, p0, p1}, Lcom/easemob/chat/EMChatManager$9;-><init>(Lcom/easemob/chat/EMChatManager;Lcom/easemob/EMConnectionListener;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/easemob/chat/EMChatManager$10;-><init>(Lcom/easemob/chat/EMChatManager;Lcom/easemob/EMConnectionListener;)V
...
.method public addConnectionListener(Lcom/easemob/chat/ConnectionListener;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/easemob/chat/EMChatManager$7;-><init>(Lcom/easemob/chat/EMChatManager;Lcom/easemob/chat/ConnectionListener;)V
    ...
    invoke-direct {v1, p0, p1}, Lcom/easemob/chat/EMChatManager$8;-><init>(Lcom/easemob/chat/EMChatManager;Lcom/easemob/chat/ConnectionListener;)V
...
.method configureCustomService(Lcom/easemob/chat/EMCustomerServiceConfiguration;)V
    .locals 1
...
.method public downloadFile(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/easemob/EMCallBack;)V
    ...
    new-instance v1, Lcom/easemob/chat/EMChatManager$15;

    invoke-direct {v1, p0, p4}, Lcom/easemob/chat/EMChatManager$15;-><init>(Lcom/easemob/chat/EMChatManager;Lcom/easemob/EMCallBack;)V
...
.method forceReconnect()V
    ...
    const-string v1, "manually force to reconnect to server"
...
.method public getAccessToken()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lcom/easemob/chat/core/p;->A()Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public getEncryptProvider()Lcom/easemob/chat/EncryptProvider;
    ...
    new-instance v0, Lcom/easemob/chat/EMChatManager$11;

    invoke-direct {v0, p0}, Lcom/easemob/chat/EMChatManager$11;-><init>(Lcom/easemob/chat/EMChatManager;)V
...
.method public getKeywordInfoList(Ljava/lang/String;)Ljava/util/Map;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/easemob/chat/core/i;->q(Ljava/lang/String;)Ljava/util/Map;
...
.method public getMessagesByKeyword(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p4}, Lcom/easemob/chat/EMGroupManager;->getGroup(Ljava/lang/String;)Lcom/easemob/chat/EMGroup;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/easemob/chat/core/i;->a(Lcom/easemob/chat/EMMessage$ChatType;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/util/List;
...
.method public getVoiceInputLevel()I
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/easemob/chat/EMVoiceCallManager;->getVoiceInputLevel()I
...
.method loadDB()V
    ...
    new-instance v0, Lcom/easemob/chat/EMChatManager$14;

    invoke-direct {v0, p0}, Lcom/easemob/chat/EMChatManager$14;-><init>(Lcom/easemob/chat/EMChatManager;)V
...
.method public logout()V
    ...
    invoke-virtual {v0}, Lcom/easemob/chat/core/j;->l()V
...
.method public onEnterForeground()V
    ...
    invoke-virtual {p0}, Lcom/easemob/chat/EMChatManager;->reconnect()V
...
.method public onReconnectionSuccessful()V
    ...
    new-instance v1, Lcom/easemob/chat/EMChatManager$12;

    invoke-direct {v1, p0}, Lcom/easemob/chat/EMChatManager$12;-><init>(Lcom/easemob/chat/EMChatManager;)V
    ...
    invoke-direct {v1, p0}, Lcom/easemob/chat/EMChatManager$13;-><init>(Lcom/easemob/chat/EMChatManager;)V
...
.method public pauseVideoTransfer()V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/easemob/chat/EMVoiceCallManager;->pauseVideoTransfer()V

    return-void
.end method

.method public pauseVoiceTransfer()V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/easemob/chat/EMVoiceCallManager;->pauseVoiceTransfer()V
...
.method public reconnect()V
    ...
    invoke-virtual {v0}, Lcom/easemob/chat/EMSessionManager;->reconnect()V
...
.method public resumeVideoTransfer()V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/easemob/chat/EMVoiceCallManager;->resumeVideoTransfer()V

    return-void
.end method

.method public resumeVoiceTransfer()V
    .locals 1
    ...
    invoke-virtual {v0}, Lcom/easemob/chat/EMVoiceCallManager;->resumeVoiceTransfer()V
...
.method public sendMessage(Lcom/easemob/chat/EMMessage;Lcom/easemob/EMCallBack;)V
    ...
    invoke-direct {p0, p2, p1}, Lcom/easemob/chat/EMChatManager;->getInnerCallBack(Lcom/easemob/EMCallBack;Lcom/easemob/chat/EMMessage;)Lcom/easemob/EMCallBack;
    ...
    invoke-static {v2, v0, v1}, Lcom/easemob/chat/EMMessageUtils;->asyncCallback(Lcom/easemob/EMCallBack;ILjava/lang/String;)V
    ...
    iget-object v5, p1, Lcom/easemob/chat/EMMessage;->status:Lcom/easemob/chat/EMMessage$Status;

    invoke-virtual {v5}, Lcom/easemob/chat/EMMessage$Status;->ordinal()I
    ...
    iget-object v4, p1, Lcom/easemob/chat/EMMessage;->msgId:Ljava/lang/String;

    invoke-virtual {v3, v4, v1}, Lcom/easemob/chat/core/i;->a(Ljava/lang/String;Landroid/content/ContentValues;)V
    ...
    invoke-virtual {v0, p1, v2}, Lcom/easemob/chat/EMMessageHandler;->sendGroupMessage(Lcom/easemob/chat/EMMessage;Lcom/easemob/EMCallBack;)V
    ...
    const-string v4, "create a new chat for jid:"
    ...
    invoke-virtual {v0, v1, v3}, Lorg/jivesoftware/smack/ChatManager;->createChat(Ljava/lang/String;Lorg/jivesoftware/smack/MessageListener;)Lorg/jivesoftware/smack/Chat;
    ...
    invoke-virtual {v1, v0, p1, v2}, Lcom/easemob/chat/EMMessageHandler;->sendMessage(Lorg/jivesoftware/smack/Chat;Lcom/easemob/chat/EMMessage;Lcom/easemob/EMCallBack;)V
...
.method public setMipushConfig(Ljava/lang/String;Ljava/lang/String;)V
    .locals 2
    ...
    new-instance v1, Lcom/easemob/chat/core/p$a;

    invoke-direct {v1, p1, p2}, Lcom/easemob/chat/core/p$a;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v0, v1}, Lcom/easemob/chat/core/p;->a(Lcom/easemob/chat/core/p$a;)V
...
.method public updateCurrentUserNick(Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v4, v0, v2, v5}, Lcom/easemob/cloud/EMHttpClient;->sendRequest(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)Landroid/util/Pair;
