...
# static fields
.field private static final MAX_RETRIES_TIMES_ON_CONNECTION_REFUSED:I = 0x14
...
.method public static sendHttpRequest(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lcom/easemob/chat/core/p;->i()Z
    ...
    instance-of v5, v3, Lorg/apache/http/conn/ConnectTimeoutException;
    ...
    invoke-virtual {v9}, Lcom/easemob/chat/EMChat;->getAppContext()Landroid/content/Context;

    move-result-object v9

    invoke-static {v9}, Lcom/easemob/util/NetUtils;->hasNetwork(Landroid/content/Context;)Z
    ...
    iget-object v9, v0, Lcom/easemob/chat/core/j$c;->a:Ljava/lang/String;
...
.method static sendHttpRequestWithRetryToken(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)Landroid/util/Pair;
    ...
    invoke-virtual {v0}, Lcom/easemob/chat/core/p;->B()Ljava/lang/String;
...
.method public static sendRequest(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)Landroid/util/Pair;
    ...
    const-string v9, "failed to send request, request url: "
...
.method public static sendRequestWithToken(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)Landroid/util/Pair;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :try_start_0
    invoke-static {p0, p1, p2, p3}, Lcom/easemob/cloud/HttpClientManager;->sendHttpRequestWithRetryToken(Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/lang/String;)Landroid/util/Pair;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
