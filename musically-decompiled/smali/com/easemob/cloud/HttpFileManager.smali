...
.method private downloadFileWithCountDown(Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/easemob/cloud/CloudOperationCallback;I)V
    ...
    invoke-static {v3}, Lcom/easemob/cloud/HttpClientConfig;->getDefaultHttpClient(I)Lorg/apache/http/impl/client/DefaultHttpClient;
    ...
    invoke-static {v6, v3}, Lcom/easemob/cloud/HttpClientManager;->checkAndProcessSSL(Ljava/lang/String;Lorg/apache/http/impl/client/DefaultHttpClient;)V
    ...
    invoke-virtual {v4}, Lcom/easemob/chat/core/p;->i()Z
    ...
    :goto_1
    iget-object v4, p0, Lcom/easemob/cloud/HttpFileManager;->appContext:Landroid/content/Context;

    invoke-static {v4}, Lcom/easemob/util/NetUtils;->hasNetwork(Landroid/content/Context;)Z
    ...
    invoke-virtual {v3}, Lcom/easemob/chat/core/j;->g()Lcom/easemob/chat/core/j$c;
    ...
    invoke-direct {p0, v3, v0, v1}, Lcom/easemob/cloud/HttpFileManager;->onDownloadCompleted(Lorg/apache/http/HttpResponse;Lcom/easemob/cloud/CloudOperationCallback;Ljava/lang/String;)J
    ...
    invoke-virtual {v2}, Lcom/easemob/analytics/EMTimeTag;->timeSpent()J
    ...
    invoke-static {v2, v8, v9, v6}, Lcom/easemob/analytics/EMPerformanceCollector;->collectDownloadFileTime(Lcom/easemob/analytics/EMTimeTag;JLjava/lang/String;)V
...
.method private processHeaders(Lorg/apache/http/client/methods/HttpGet;Ljava/util/Map;)V
    ...
    invoke-virtual {v2}, Lcom/easemob/chat/core/p;->A()Ljava/lang/String;
...
.method private sendFiletoServerHttpWithCountDown(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/easemob/cloud/CloudOperationCallback;IZ)V
    ...
    const-string v5, " remote path url : "
    ...
    new-instance v3, Linternal/org/apache/http/entity/mime/a/e;

    move-object/from16 v0, p3

    invoke-direct {v3, v0}, Linternal/org/apache/http/entity/mime/a/e;-><init>(Ljava/lang/String;)V

    invoke-virtual {v7, v2, v3}, Lcom/easemob/cloud/CustomMultiPartEntity;->addPart(Ljava/lang/String;Linternal/org/apache/http/entity/mime/a/b;)V
    ...
    new-instance v10, Linternal/org/apache/http/entity/mime/a/e;

    invoke-direct {v10, v3}, Linternal/org/apache/http/entity/mime/a/e;-><init>(Ljava/lang/String;)V

    invoke-virtual {v7, v9, v10}, Lcom/easemob/cloud/CustomMultiPartEntity;->addPart(Ljava/lang/String;Linternal/org/apache/http/entity/mime/a/b;)V

    :goto_2
    invoke-static {v4}, Lcom/easemob/cloud/HttpFileManager;->getMimeType(Ljava/io/File;)Ljava/lang/String;
    ...
    new-instance v10, Linternal/org/apache/http/entity/mime/a/d;

    const-string v12, "UTF-8"

    invoke-direct {v10, v4, v2, v3, v12}, Linternal/org/apache/http/entity/mime/a/d;-><init>(Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/easemob/chat/core/p;->Q()Z

    move-result v2

    if-eqz v2, :cond_6

    invoke-static {v11, v5}, Lcom/easemob/cloud/HttpClientManager;->checkAndProcessSSL(Ljava/lang/String;Lorg/apache/http/impl/client/DefaultHttpClient;)V
    ...
    invoke-static {v2, v4, v5, v11}, Lcom/easemob/analytics/EMPerformanceCollector;->collectUploadFileTime(Lcom/easemob/analytics/EMTimeTag;JLjava/lang/String;)V
    ...
    const-string v6, "sendFiletoServerHttp:"
    ...
    invoke-static {v4, v5}, Lcom/easemob/util/EMLog;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-interface {v0, v2}, Lcom/easemob/cloud/CloudOperationCallback;->onProgress(I)V
    ...
    invoke-virtual {v2}, Lcom/easemob/chat/core/p;->B()Ljava/lang/String;
