...
.method private createTunnel(IILcom/squareup/okhttp/Request;)V
    ...
    :cond_1
    invoke-virtual {v4, v0, v1}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newFixedLengthSource(J)Lokio/t;
    ...
    invoke-static {v0, v1, v7}, Lcom/squareup/okhttp/internal/Util;->skipAll(Lokio/t;ILjava/util/concurrent/TimeUnit;)Z
...
.method rawSink()Lokio/e;
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/http/HttpConnection;->rawSink()Lokio/e;
...
.method rawSource()Lokio/f;
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/http/HttpConnection;->rawSource()Lokio/f;
