...
.method public static discard(Lokio/t;ILjava/util/concurrent/TimeUnit;)Z
    .locals 1

    :try_start_0
    invoke-static {p0, p1, p2}, Lcom/squareup/okhttp/internal/Util;->skipAll(Lokio/t;ILjava/util/concurrent/TimeUnit;)Z
    :try_end_0
...
.method public static skipAll(Lokio/t;ILjava/util/concurrent/TimeUnit;)Z
    .locals 12
    ...
    invoke-virtual {v4, v8, v9}, Lokio/u;->deadlineNanoTime(J)Lokio/u;
    ...
    invoke-interface {p0, v4, v8, v9}, Lokio/t;->read(Lokio/d;J)J
    ...
    invoke-virtual {v2, v0, v1}, Lokio/u;->deadlineNanoTime(J)Lokio/u;
...
.method public static toHumanReadableAscii(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v4, p0, v1, v0}, Lokio/d;->a(Ljava/lang/String;II)Lokio/d;
    ...
    :goto_2
    invoke-virtual {v4, v0}, Lokio/d;->a(I)Lokio/d;
    ...
    :cond_2
    invoke-virtual {v4}, Lokio/d;->p()Ljava/lang/String;
