...
.field private final headerBlockBuffer:Lokio/d;

.field private final headerBlockOut:Lokio/e;

.field private final sink:Lokio/e;
...
.method constructor <init>(Lokio/e;Z)V
    ...
    iput-object p1, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->sink:Lokio/e;
    ...
    iput-object v1, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockBuffer:Lokio/d;

    new-instance v1, Lokio/g;

    iget-object v2, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockBuffer:Lokio/d;

    invoke-direct {v1, v2, v0}, Lokio/g;-><init>(Lokio/s;Ljava/util/zip/Deflater;)V

    invoke-static {v1}, Lokio/m;->a(Lokio/s;)Lokio/e;

    move-result-object v0

    iput-object v0, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockOut:Lokio/e;
...
.method private writeNameValueBlockToBuffer(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockOut:Lokio/e;

    invoke-interface {p1}, Ljava/util/List;->size()I

    move-result v1

    invoke-interface {v0, v1}, Lokio/e;->g(I)Lokio/e;
    ...
    iget-object v3, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockOut:Lokio/e;

    invoke-virtual {v0}, Lokio/ByteString;->size()I

    move-result v4

    invoke-interface {v3, v4}, Lokio/e;->g(I)Lokio/e;

    iget-object v3, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockOut:Lokio/e;

    invoke-interface {v3, v0}, Lokio/e;->b(Lokio/ByteString;)Lokio/e;
...
.method public declared-synchronized close()V
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->sink:Lokio/e;

    iget-object v1, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockOut:Lokio/e;
...
.method public declared-synchronized data(ZILokio/d;I)V
    .locals 1
    ...
    :goto_0
    :try_start_0
    invoke-virtual {p0, p2, v0, p3, p4}, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->sendDataFrame(IILokio/d;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized goAway(ILcom/squareup/okhttp/internal/framed/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lokio/e;->g(I)Lokio/e;
...
.method public declared-synchronized headers(ILjava/util/List;)V
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockBuffer:Lokio/d;
    ...
    iget-object v1, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->sink:Lokio/e;

    const v2, -0x7ffcfff8

    invoke-interface {v1, v2}, Lokio/e;->g(I)Lokio/e;
    ...
    invoke-interface {v1, v0}, Lokio/e;->g(I)Lokio/e;
    ...
    iget-object v1, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->headerBlockBuffer:Lokio/d;

    invoke-interface {v0, v1}, Lokio/e;->a(Lokio/t;)J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method public declared-synchronized ping(ZII)V
    ...
    invoke-interface {v0, p2}, Lokio/e;->g(I)Lokio/e;
...
.method sendDataFrame(IILokio/d;I)V
    .locals 4
    ...
    invoke-interface {v0, p3, v2, v3}, Lokio/e;->write(Lokio/d;J)V
...
.method public declared-synchronized settings(Lcom/squareup/okhttp/internal/framed/Settings;)V
    ...
    iget-object v2, p0, Lcom/squareup/okhttp/internal/framed/Spdy3$Writer;->sink:Lokio/e;

    const v3, -0x7ffcfffc

    invoke-interface {v2, v3}, Lokio/e;->g(I)Lokio/e;
    ...
    invoke-interface {v2, v1}, Lokio/e;->g(I)Lokio/e;
...
.method public declared-synchronized synReply(ZILjava/util/List;)V
    ...
    invoke-interface {v2, v0}, Lokio/e;->g(I)Lokio/e;
...
.method public declared-synchronized synStream(ZZIILjava/util/List;)V
    ...
    invoke-interface {v1, v3}, Lokio/e;->g(I)Lokio/e;
    ...
    invoke-interface {v0, v1}, Lokio/e;->h(I)Lokio/e;
