...
.method private constructor <init>(Lcom/squareup/okhttp/internal/framed/FramedConnection$Builder;)V
    ...
    invoke-static {v1}, Lokio/m;->a(Ljava/net/Socket;)Lokio/s;
    ...
    invoke-interface {v0, v1, v2}, Lcom/squareup/okhttp/internal/framed/Variant;->newWriter(Lokio/e;Z)Lcom/squareup/okhttp/internal/framed/FrameWriter;
...
.method static synthetic access$1200(Lcom/squareup/okhttp/internal/framed/FramedConnection;ILokio/f;IZ)V
    .locals 0

    invoke-direct {p0, p1, p2, p3, p4}, Lcom/squareup/okhttp/internal/framed/FramedConnection;->pushDataLater(ILokio/f;IZ)V
...
.method private pushDataLater(ILokio/f;IZ)V
    .locals 9
    ...
    invoke-interface {p2, v0, v1}, Lokio/f;->a(J)V

    int-to-long v0, p3

    invoke-interface {p2, v5, v0, v1}, Lokio/f;->read(Lokio/d;J)J

    invoke-virtual {v5}, Lokio/d;->a()J
    ...
    invoke-direct/range {v0 .. v7}, Lcom/squareup/okhttp/internal/framed/FramedConnection$6;-><init>(Lcom/squareup/okhttp/internal/framed/FramedConnection;Ljava/lang/String;[Ljava/lang/Object;ILokio/d;IZ)V
...
.method public writeData(IZLokio/d;J)V
    .locals 10
    ...
    invoke-interface {v0, p2, p1, p3, v1}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->data(ZILokio/d;I)V
    ...
    :goto_0
    invoke-interface {v3, v0, p1, p3, v2}, Lcom/squareup/okhttp/internal/framed/FrameWriter;->data(ZILokio/d;I)V
