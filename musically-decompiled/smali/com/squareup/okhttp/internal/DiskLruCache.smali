...
.field private static final NULL_SINK:Lokio/s;
...
.field private journalWriter:Lokio/e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/squareup/okhttp/internal/DiskLruCache;->NULL_SINK:Lokio/s;
...
.method static synthetic access$2500()Lokio/s;
    .locals 1

    sget-object v0, Lcom/squareup/okhttp/internal/DiskLruCache;->NULL_SINK:Lokio/s;
...
.method private declared-synchronized completeEdit(Lcom/squareup/okhttp/internal/DiskLruCache$Editor;Z)V
    ...
    iget-object v0, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lokio/e;

    const-string v1, "CLEAN"

    invoke-interface {v0, v1}, Lokio/e;->b(Ljava/lang/String;)Lokio/e;

    move-result-object v0

    const/16 v1, 0x20

    invoke-interface {v0, v1}, Lokio/e;->i(I)Lokio/e;
    ...
    invoke-virtual {v2, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$Entry;->writeLengths(Lokio/e;)V
...
.method private declared-synchronized edit(Ljava/lang/String;J)Lcom/squareup/okhttp/internal/DiskLruCache$Editor;
    ...
    :cond_2
    iget-object v2, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lokio/e;
    ...
    invoke-interface {v2, v3}, Lokio/e;->i(I)Lokio/e;

    move-result-object v2

    invoke-interface {v2, p1}, Lokio/e;->b(Ljava/lang/String;)Lokio/e;
    ...
    invoke-interface {v2}, Lokio/e;->flush()V
...
.method private newJournalWriter()Lokio/e;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Lokio/s;

    move-result-object v0

    new-instance v1, Lcom/squareup/okhttp/internal/DiskLruCache$2;

    invoke-direct {v1, p0, v0}, Lcom/squareup/okhttp/internal/DiskLruCache$2;-><init>(Lcom/squareup/okhttp/internal/DiskLruCache;Lokio/s;)V
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->source(Ljava/io/File;)Lokio/t;
    ...
    :try_start_0
    invoke-interface {v1}, Lokio/f;->q()Ljava/lang/String;
    ...
    invoke-interface {v1}, Lokio/f;->e()Z
    ...
    :cond_2
    :try_start_3
    invoke-direct {p0}, Lcom/squareup/okhttp/internal/DiskLruCache;->newJournalWriter()Lokio/e;

    move-result-object v0

    iput-object v0, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lokio/e;
    :try_end_3
...
.method private declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lcom/squareup/okhttp/internal/io/FileSystem;->sink(Ljava/io/File;)Lokio/s;
    ...
    invoke-interface {v1, v0}, Lokio/e;->b(Ljava/lang/String;)Lokio/e;

    move-result-object v0

    const/16 v2, 0xa

    invoke-interface {v0, v2}, Lokio/e;->i(I)Lokio/e;
    ...
    invoke-interface {v1, v2, v3}, Lokio/e;->k(J)Lokio/e;
    ...
    invoke-interface {v1, v0}, Lokio/e;->i(I)Lokio/e;
    ...
    invoke-interface {v1, v3}, Lokio/e;->b(Ljava/lang/String;)Lokio/e;

    move-result-object v3

    const/16 v4, 0x20

    invoke-interface {v3, v4}, Lokio/e;->i(I)Lokio/e;
    ...
    invoke-virtual {v0, v1}, Lcom/squareup/okhttp/internal/DiskLruCache$Entry;->writeLengths(Lokio/e;)V
...
.method public declared-synchronized get(Ljava/lang/String;)Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;
    ...
    iget-object v1, p0, Lcom/squareup/okhttp/internal/DiskLruCache;->journalWriter:Lokio/e;

    const-string v2, "READ"

    invoke-interface {v1, v2}, Lokio/e;->b(Ljava/lang/String;)Lokio/e;

    move-result-object v1

    const/16 v2, 0x20

    invoke-interface {v1, v2}, Lokio/e;->i(I)Lokio/e;

    move-result-object v1

    invoke-interface {v1, p1}, Lokio/e;->b(Ljava/lang/String;)Lokio/e;
