...
.method snapshot()Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;
    ...
    invoke-direct/range {v1 .. v8}, Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;-><init>(Lcom/squareup/okhttp/internal/DiskLruCache;Ljava/lang/String;J[Lokio/t;[JLcom/squareup/okhttp/internal/DiskLruCache$1;)V
    :try_end_0
...
.method writeLengths(Lokio/e;)V
    ...
    invoke-interface {p1, v3}, Lokio/e;->i(I)Lokio/e;

    move-result-object v3

    invoke-interface {v3, v4, v5}, Lokio/e;->k(J)Lokio/e;
