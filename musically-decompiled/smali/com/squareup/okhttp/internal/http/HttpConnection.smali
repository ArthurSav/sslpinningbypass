...
.method public constructor <init>(Lcom/squareup/okhttp/ConnectionPool;Lcom/squareup/okhttp/Connection;Ljava/net/Socket;)V
    ...
    invoke-static {p3}, Lokio/m;->b(Ljava/net/Socket;)Lokio/t;
    ...
    iput-object v0, p0, Lcom/squareup/okhttp/internal/http/HttpConnection;->source:Lokio/f;

    invoke-static {p3}, Lokio/m;->a(Ljava/net/Socket;)Lokio/s;
    ...
    iput-object v0, p0, Lcom/squareup/okhttp/internal/http/HttpConnection;->sink:Lokio/e;

    return-void
.end method

.method static synthetic access$300(Lcom/squareup/okhttp/internal/http/HttpConnection;)Lokio/e;
    .locals 1

    iget-object v0, p0, Lcom/squareup/okhttp/internal/http/HttpConnection;->sink:Lokio/e;

    return-object v0
.end method

.method static synthetic access$400(Lcom/squareup/okhttp/internal/http/HttpConnection;Lokio/j;)V
    .locals 0

    invoke-direct {p0, p1}, Lcom/squareup/okhttp/internal/http/HttpConnection;->detachTimeout(Lokio/j;)V
...
.method static synthetic access$600(Lcom/squareup/okhttp/internal/http/HttpConnection;)Lokio/f;
    .locals 1

    iget-object v0, p0, Lcom/squareup/okhttp/internal/http/HttpConnection;->source:Lokio/f;
...
.method private detachTimeout(Lokio/j;)V
    .locals 2

    invoke-virtual {p1}, Lokio/j;->a()Lokio/u;

    move-result-object v0

    sget-object v1, Lokio/u;->NONE:Lokio/u;

    invoke-virtual {p1, v1}, Lokio/j;->a(Lokio/u;)Lokio/j;
...
.method public isReadable()Z
    ...
    iget-object v2, p0, Lcom/squareup/okhttp/internal/http/HttpConnection;->source:Lokio/f;
...
.method public newChunkedSink()Lokio/s;
    .locals 3
...
.method public newChunkedSource(Lcom/squareup/okhttp/internal/http/HttpEngine;)Lokio/t;
    .locals 3
...
.method public newFixedLengthSink(J)Lokio/s;
    .locals 3
...
.method public newFixedLengthSource(J)Lokio/t;
    .locals 3
...
.method public newUnknownLengthSource()Lokio/t;
    .locals 3
...
.method public rawSource()Lokio/f;
    .locals 1
...
.method public readHeaders(Lcom/squareup/okhttp/Headers$Builder;)V
    ...
    invoke-interface {v0}, Lokio/f;->q()Ljava/lang/String;
...
.method public setTimeouts(II)V
    ...
    invoke-virtual {v0, v2, v3, v1}, Lokio/u;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/u;
...
.method public writeRequest(Lcom/squareup/okhttp/Headers;Ljava/lang/String;)V
    ...
    invoke-interface {v0, p2}, Lokio/e;->b(Ljava/lang/String;)Lokio/e;
    ...
    iget-object v2, p0, Lcom/squareup/okhttp/internal/http/HttpConnection;->sink:Lokio/e;
...
.method public writeRequestBody(Lcom/squareup/okhttp/internal/http/RetryableSink;)V
    ...
    invoke-virtual {p1, v0}, Lcom/squareup/okhttp/internal/http/RetryableSink;->writeToSocket(Lokio/s;)V
