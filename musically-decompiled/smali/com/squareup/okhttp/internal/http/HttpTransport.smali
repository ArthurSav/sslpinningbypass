...
.method private getTransferStream(Lcom/squareup/okhttp/Response;)Lokio/t;
    .locals 4
    ...
    invoke-virtual {v0, v2, v3}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newFixedLengthSource(J)Lokio/t;
    ...
    invoke-virtual {v0, v1}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newChunkedSource(Lcom/squareup/okhttp/internal/http/HttpEngine;)Lokio/t;
    ...
    invoke-virtual {v2, v0, v1}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newFixedLengthSource(J)Lokio/t;
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newUnknownLengthSource()Lokio/t;
...
.method public createRequestBody(Lcom/squareup/okhttp/Request;J)Lokio/s;
    .locals 2
    ...
    invoke-virtual {v0}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newChunkedSink()Lokio/s;
    ...
    invoke-virtual {v0, p2, p3}, Lcom/squareup/okhttp/internal/http/HttpConnection;->newFixedLengthSink(J)Lokio/s;
...
.method public openResponseBody(Lcom/squareup/okhttp/Response;)Lcom/squareup/okhttp/ResponseBody;
    ...
    invoke-direct {p0, p1}, Lcom/squareup/okhttp/internal/http/HttpTransport;->getTransferStream(Lcom/squareup/okhttp/Response;)Lokio/t;
    ...
    invoke-direct {v1, v2, v0}, Lcom/squareup/okhttp/internal/http/RealResponseBody;-><init>(Lcom/squareup/okhttp/Headers;Lokio/f;)V
