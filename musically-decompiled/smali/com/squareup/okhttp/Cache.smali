...
.method static synthetic access$1000(Lokio/f;)I
    .locals 1

    invoke-static {p0}, Lcom/squareup/okhttp/Cache;->readInt(Lokio/f;)I
...
.method private static readInt(Lokio/f;)I
    .locals 6

    :try_start_0
    invoke-interface {p0}, Lokio/f;->m()J

    move-result-wide v0

    invoke-interface {p0}, Lokio/f;->q()Ljava/lang/String;
...
.method get(Lcom/squareup/okhttp/Request;)Lcom/squareup/okhttp/Response;
    ...
    invoke-virtual {v1, v3}, Lcom/squareup/okhttp/internal/DiskLruCache$Snapshot;->getSource(I)Lokio/t;

    move-result-object v3

    invoke-direct {v2, v3}, Lcom/squareup/okhttp/Cache$Entry;-><init>(Lokio/t;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
