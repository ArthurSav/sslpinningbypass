...
.method public static a(Landroid/support/v4/app/FragmentActivity;)Lcom/google/android/gms/common/api/zzn;
    .locals 4
    ...
    invoke-virtual {p0}, Landroid/support/v4/app/FragmentActivity;->f()Landroid/support/v4/app/r;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/api/zzn;->o()Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/app/w;->a()I
...
.method private a()V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/zzn;->r()Landroid/support/v4/app/ab;
    ...
    invoke-virtual {p0, v2}, Lcom/google/android/gms/common/api/zzn;->d(I)Lcom/google/android/gms/common/api/au;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3}, Lcom/google/android/gms/common/api/au;->b()Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v1, v2}, Landroid/support/v4/app/ab;->a(I)V

    invoke-virtual {v1, v2, v4, p0}, Landroid/support/v4/app/ab;->a(ILandroid/os/Bundle;Landroid/support/v4/app/ac;)Landroid/support/v4/content/Loader;
...
.method private b(ILcom/google/android/gms/common/ConnectionResult;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/zzn;->c(I)V

    iget-object v0, v0, Lcom/google/android/gms/common/api/av;->b:Lcom/google/android/gms/common/api/r;
...
.method public a(ILandroid/os/Bundle;)Landroid/support/v4/content/Loader;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/zzn;->h()Landroid/support/v4/app/FragmentActivity;
...
.method public a(ILcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/common/api/r;)V
    .locals 5
    ...
    invoke-direct {v0, p2, p3, v4}, Lcom/google/android/gms/common/api/av;-><init>(Lcom/google/android/gms/common/api/GoogleApiClient;Lcom/google/android/gms/common/api/r;Lcom/google/android/gms/common/api/zzn$1;)V
    ...
    invoke-static {v1}, Landroid/support/v4/app/ab;->a(Z)V

    invoke-virtual {p0}, Lcom/google/android/gms/common/api/zzn;->r()Landroid/support/v4/app/ab;

    move-result-object v0

    invoke-virtual {v0, p1, v4, p0}, Landroid/support/v4/app/ab;->a(ILandroid/os/Bundle;Landroid/support/v4/app/ac;)Landroid/support/v4/content/Loader;
...
.method public a(Landroid/app/Activity;)V
    ...
    iget-object v3, v3, Lcom/google/android/gms/common/api/au;->a:Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    invoke-virtual {v0, v2, v4, p0}, Landroid/support/v4/app/ab;->b(ILandroid/os/Bundle;Landroid/support/v4/app/ac;)Landroid/support/v4/content/Loader;
    ...
    invoke-virtual {v0, v2, v4, p0}, Landroid/support/v4/app/ab;->a(ILandroid/os/Bundle;Landroid/support/v4/app/ac;)Landroid/support/v4/content/Loader;
...
.method public a(Landroid/support/v4/content/Loader;Lcom/google/android/gms/common/ConnectionResult;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/content/Loader;->k()I
...
.method public synthetic a(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/google/android/gms/common/api/zzn;->a(Landroid/support/v4/content/Loader;Lcom/google/android/gms/common/ConnectionResult;)V

    return-void
.end method

.method public b(I)Lcom/google/android/gms/common/api/GoogleApiClient;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/zzn;->d(I)Lcom/google/android/gms/common/api/au;

    move-result-object v0

    if-eqz v0, :cond_0

    iget-object v0, v0, Lcom/google/android/gms/common/api/au;->a:Lcom/google/android/gms/common/api/GoogleApiClient;
...
.method public c()V
    ...
    invoke-virtual {v1, v2, v3, p0}, Landroid/support/v4/app/ab;->a(ILandroid/os/Bundle;Landroid/support/v4/app/ac;)Landroid/support/v4/content/Loader;
...
.method public c(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/ab;->a(I)V

    return-void
.end method

.method d(I)Lcom/google/android/gms/common/api/au;
    .locals 3
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/ab;->b(I)Landroid/support/v4/content/Loader;
