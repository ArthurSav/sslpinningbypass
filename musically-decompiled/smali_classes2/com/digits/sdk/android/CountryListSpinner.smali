...
.implements Lcom/digits/sdk/android/x;


# instance fields
.field private a:Ljava/lang/String;

.field private b:Lcom/digits/sdk/android/y;

.field private c:Lcom/digits/sdk/android/CountryListAdapter;
...
.method private a()V
    ...
    new-instance v0, Lcom/digits/sdk/android/CountryListAdapter;

    invoke-virtual {p0}, Lcom/digits/sdk/android/CountryListSpinner;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, v1}, Lcom/digits/sdk/android/CountryListAdapter;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Lcom/digits/sdk/android/CountryListSpinner;->c:Lcom/digits/sdk/android/CountryListAdapter;

    new-instance v0, Lcom/digits/sdk/android/y;

    iget-object v1, p0, Lcom/digits/sdk/android/CountryListSpinner;->c:Lcom/digits/sdk/android/CountryListAdapter;

    invoke-direct {v0, p0, v1}, Lcom/digits/sdk/android/y;-><init>(Lcom/digits/sdk/android/CountryListSpinner;Lcom/digits/sdk/android/CountryListAdapter;)V

    iput-object v0, p0, Lcom/digits/sdk/android/CountryListSpinner;->b:Lcom/digits/sdk/android/y;

    invoke-virtual {p0}, Lcom/digits/sdk/android/CountryListSpinner;->getResources()Landroid/content/res/Resources;

    move-result-object v0

    sget v1, Lcom/digits/sdk/android/R$string;->dgts__country_spinner_format:I
...
.method private b()V
    ...
    invoke-direct {v0, p0}, Lcom/digits/sdk/android/w;-><init>(Lcom/digits/sdk/android/x;)V
    ...
    invoke-virtual {v0, v1, v2}, Lcom/digits/sdk/android/w;->a(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Lio/fabric/sdk/android/services/concurrency/AsyncTask;
...
.method public a(Ljava/util/List;)V
    ...
    iget-object v0, p0, Lcom/digits/sdk/android/CountryListSpinner;->c:Lcom/digits/sdk/android/CountryListAdapter;

    invoke-virtual {v0, p1}, Lcom/digits/sdk/android/CountryListAdapter;->a(Ljava/util/List;)V

    iget-object v0, p0, Lcom/digits/sdk/android/CountryListSpinner;->b:Lcom/digits/sdk/android/y;

    iget-object v1, p0, Lcom/digits/sdk/android/CountryListSpinner;->c:Lcom/digits/sdk/android/CountryListAdapter;

    iget-object v2, p0, Lcom/digits/sdk/android/CountryListSpinner;->e:Ljava/lang/String;

    invoke-virtual {v1, v2}, Lcom/digits/sdk/android/CountryListAdapter;->a(Ljava/lang/String;)I

    move-result v1

    invoke-virtual {v0, v1}, Lcom/digits/sdk/android/y;->a(I)V
...
.method public onClick(Landroid/view/View;)V
    ...
    invoke-static {v0, p0}, Lio/fabric/sdk/android/services/common/h;->a(Landroid/content/Context;Landroid/view/View;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0}, Lcom/digits/sdk/android/y;->b()Z
    ...
    invoke-virtual {v0}, Lcom/digits/sdk/android/y;->a()V

    :cond_0
    return-void
.end method

.method setDialogPopup(Lcom/digits/sdk/android/y;)V
    .locals 0

    iput-object p1, p0, Lcom/digits/sdk/android/CountryListSpinner;->b:Lcom/digits/sdk/android/y;
