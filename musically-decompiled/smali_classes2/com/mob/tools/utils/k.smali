...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/mob/tools/utils/k;->a:[Ljava/lang/String;
...
.method private static declared-synchronized a()V
    ...
    const-class v1, Lcom/mob/tools/utils/k;

    monitor-enter v1

    :try_start_0
    sget-object v0, Lcom/mob/tools/utils/k;->b:Landroid/os/Handler;

    if-nez v0, :cond_0

    invoke-static {}, Lcom/mob/tools/utils/k;->b()V

    invoke-static {}, Lcom/mob/tools/utils/k;->c()V
    :try_end_0
...
.method static synthetic a(Landroid/os/Message;)V
    ...
    invoke-static {p0}, Lcom/mob/tools/utils/k;->b(Landroid/os/Message;)V
...
.method public static a(IJLandroid/os/Handler$Callback;)Z
    ...
    invoke-static {}, Lcom/mob/tools/utils/k;->a()V

    sget-object v0, Lcom/mob/tools/utils/k;->b:Landroid/os/Handler;

    invoke-static {p0, p3}, Lcom/mob/tools/utils/k;->b(ILandroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static a(ILandroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p1}, Lcom/mob/tools/utils/k;->b(ILandroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static a(Landroid/os/Message;JLandroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p3}, Lcom/mob/tools/utils/k;->b(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static a(Landroid/os/Message;Landroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p1}, Lcom/mob/tools/utils/k;->b(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
...
.method private static b(ILandroid/os/Handler$Callback;)Landroid/os/Message;
    ...
    invoke-static {v0, p1}, Lcom/mob/tools/utils/k;->b(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
...
.method private static b(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
    ...
    new-instance v1, Lcom/mob/tools/utils/l;

    invoke-direct {v1, p0, p1}, Lcom/mob/tools/utils/l;-><init>(Landroid/os/Message;Landroid/os/Handler$Callback;)V
...
.method private static b()V
    ...
    new-instance v2, Lcom/mob/tools/utils/k$1;

    invoke-direct {v2}, Lcom/mob/tools/utils/k$1;-><init>()V

    invoke-direct {v0, v1, v2}, Landroid/os/Handler;-><init>(Landroid/os/Looper;Landroid/os/Handler$Callback;)V

    sput-object v0, Lcom/mob/tools/utils/k;->b:Landroid/os/Handler;
...
.method private static b(Landroid/os/Message;)V
    ...
    check-cast v0, Lcom/mob/tools/utils/l;

    iget-object v1, v0, Lcom/mob/tools/utils/l;->a:Landroid/os/Message;

    iget-object v0, v0, Lcom/mob/tools/utils/l;->b:Landroid/os/Handler$Callback;
...
.method private static c()V
    ...
    sget-object v1, Lcom/mob/tools/utils/k;->a:[Ljava/lang/String;
    ...
    invoke-static {v0, v1}, Lcom/mob/tools/utils/g;->a(Ljava/lang/Object;[Ljava/lang/Object;)I
    :try_end_0
