...
.method constructor <init>(Landroid/support/v4/widget/SlidingPaneLayout;)V
    ...
    iput-object v0, p0, Landroid/support/v4/widget/ar;->c:Landroid/graphics/Rect;
...
.method private a(Landroid/support/v4/view/a/l;Landroid/support/v4/view/a/l;)V
    ...
    iget-object v0, p0, Landroid/support/v4/widget/ar;->c:Landroid/graphics/Rect;
...
.method public a(Landroid/view/View;Landroid/support/v4/view/a/l;)V
    ...
    invoke-super {p0, p1, v0}, Landroid/support/v4/view/a;->a(Landroid/view/View;Landroid/support/v4/view/a/l;)V

    invoke-direct {p0, p2, v0}, Landroid/support/v4/widget/ar;->a(Landroid/support/v4/view/a/l;Landroid/support/v4/view/a/l;)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/ar;->b:Landroid/support/v4/widget/SlidingPaneLayout;

    invoke-virtual {v2, v0}, Landroid/support/v4/widget/SlidingPaneLayout;->getChildAt(I)Landroid/view/View;

    move-result-object v2

    invoke-virtual {p0, v2}, Landroid/support/v4/widget/ar;->b(Landroid/view/View;)Z
...
.method public a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/view/accessibility/AccessibilityEvent;)Z
    ...
    invoke-virtual {p0, p2}, Landroid/support/v4/widget/ar;->b(Landroid/view/View;)Z
